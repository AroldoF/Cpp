...
void mostrar_matriz(int tam_alunos, int tam_disciplinas, vector<vector<string>> &notas)
{
    int escolha_int;
...
void adicionar_alunos(int tam, int tam_disciplinas)
{
    int i;
    string aluno = "";
    bool quebra = false;
...
void cadastrar_disciplinas(int tam)
{
    int i;
    string disciplina = "";
    bool quebra = false;
...
void exibirNotas(int tam_alunos, int tam_disciplinas, vector<vector<string>> &notas)
{
    int m = 1, n = 1;
    ifstream arquivo;
...
void lançar_notas( int tam_alunos, int tam_disciplinas, vector<vector<string>> &notas)
{
    string modificação = "";
    string buscas;
    bool quebra = false;
...
void relatorio(vector<vector<string>> &notas, int tam_disciplinas, int tam_alunos)
{
    int escolha;
    string var = "";
    float media = 0;
...
int main()
{
    ...
    nomes.resize(tam_alunos, vector<string>(3));
    ...
    do
    {
        ...
        cin >> escolha;
        cout << endl;
        exibirNotas(tam_alunos, tam_disciplinas, notas);
        switch (escolha)
        {
        case 1:
            mostrar_matriz(tam_alunos, tam_disciplinas,notas);
            break;
        case 2:
            adicionar_alunos(tam_alunos, tam_disciplinas);
            tam_alunos++;
            salvar_matriz("../alunos.txt", nomes);
            exibirNotas(tam_alunos, tam_disciplinas, notas);
            ...
            {
                lançar_notas( tam_alunos,  tam_disciplinas, notas);
            }
            break;
        case 3:
            cadastrar_disciplinas(tam_disciplinas);
            tam_disciplinas++;
            salvar_matriz("../disciplinas.txt", disciplinas);
            exibirNotas(tam_alunos, tam_disciplinas, notas);
            cout << "Voce quer adicionar notas? [S/N]" << endl;
        ...
        case 4:
            ...
            break;
        case 5:
            relatorio(notas,tam_disciplinas, tam_alunos);
